...
@protocol KGModalSwipeDelegate <NSObject>
- (void) actionAfterDone;
- (void) actionAfterUndo;
@end

@protocol KGModalShareRefferralDelegate <NSObject>
...
@property (nonatomic, strong) id<KGModalSwipeDelegate> delegateSwipe;
@property (nonatomic, strong) id<KGModalShareRefferralDelegate> delegateShareRefferralCode;

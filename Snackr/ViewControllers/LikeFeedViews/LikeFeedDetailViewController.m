//
//  LikeFeedDetailViewController.m
//  Snackr
//
...
@interface LikeFeedDetailViewController ()<ASFSharedViewTransitionDataSource>
{
        CLLocationCoordinate2D location;
}
@end

@implementation LikeFeedDetailViewController
...
-(void) doBack
{
    [UIView animateWithDuration:0.3 delay:0.0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        self.topView.frame = CGRectMake(0, -50, self.topView.frame.size.width, self.topView.frame.size.height);
    } completion:^(BOOL finish){
